...
router.post('/addReviews',Middleware.checkVendorToken,vendorController.addReviews);
router.post('/deleteReview',Middleware.checkVendorToken,vendorController.deleteReview);
router.post('/getReviews',Middleware.checkVendorToken,vendorController.getReviews);
