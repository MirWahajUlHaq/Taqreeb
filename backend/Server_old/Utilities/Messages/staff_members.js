module.exports = {
    Staff_ADDED                 : 'New StaffMember has been added successfully',
    SERVER_ERROR               : 'Server Error !!! Please try again later',
    Staff_UPDATED               : 'Staff details updated',
    Staff_UPDATE_FAILED         : 'Unable to update Staff at the moment',
    Staff_DELETED               : 'Staff has been deleted from system',
    Staff_DELETE_FAILED         : 'Unable to delete Staff at the moment',
    Staff_DATA                  : 'Staff details found',
    INVALID_Staff_ID            : 'No Staff detail found',
